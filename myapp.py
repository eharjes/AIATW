...
app = Flask(__name__)
search_engine = SearchEngine('https://en.wikipedia.org/wiki/Home_page', 10) # https://vm009.rz.uos.de/crawl/index.html, https://en.wikipedia.org/wiki/Home_page, https://www.nytimes.com/ https://en.wikipedia.org/wiki/Artificial_intelligence
