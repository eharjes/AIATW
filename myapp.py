...
app = Flask(__name__)
search_engine = SearchEngine('https://vm009.rz.uos.de/crawl/index.html', 100) # use https://vm009.rz.uos.de/crawl/index.html or https://en.wikipedia.org/wiki/Home_page
