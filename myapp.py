...
app = Flask(__name__)
search_engine = SearchEngine('https://en.wikipedia.org/wiki/Home_page', 100) # use https://vm009.rz.uos.de/crawl/index.html or https://en.wikipedia.org/wiki/Home_page
